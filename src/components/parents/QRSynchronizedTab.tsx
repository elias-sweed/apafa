...
export default function QRSynchronizedTab({ data, loading }: { data: any[], loading: boolean }) {
  ...
  return (
    <div className="relative">
      ...
      <div className={`gap-10 ${printMode === 'a4' ? 'grid grid-cols-1 xl:grid-cols-2 print:grid print:grid-cols-2 print:gap-4' : 'grid grid-cols-1 xl:grid-cols-2 print:block'}`}>
